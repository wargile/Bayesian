...
Overthinking: Proff of Gaussian maximum entropy
...
Figure 9.8. The log link transforms a linear model (left) into a strictly postative measurement (right). This transform results in an exponential scaling of the linear model, with a unit change on the linear scale mapping onto increasingly larger changes on the outcome scale.
